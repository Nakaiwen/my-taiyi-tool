document.addEventListener('DOMContentLoaded', () => {
    ...
    '天乙':   { '命宮': '你堅持原則，擁有不隨波逐流的獨立精神。建議你離開家鄉往外發展，你的獨特個性在國際貿易、新創或需要獨立判斷的領域更能取得成功。', '兄弟宮': '手足的健康或緣分是你需要特別留意的課題。建議你多關心兄弟姊妹的身體狀況，並珍惜與他們相處的時光。', '夫妻宮': '你的伴侶是持家好手，但婚後娘家可能會經歷衰敗。這顆星暗示，可以選擇思想更成熟或年齡稍長的伴侶，可能更有助於穩定關係，共度難關。', '子孫宮': '在養育第一個孩子時，可能需要投入比預期更多的關愛與心力。建議為他多祈福，或是寄名養育。', '財帛宮': '你的財務狀況可能經歷先散後聚的過程，年輕時的開銷或投資可能較大，但最終能累積財富。你也帶有「隔年愁」的特質，需注意別過度擔憂。', '田宅宮': '你可能無法繼承太多祖產，需要靠自己奮鬥置產。若宮位強旺，可以考慮從事與「金屬、機械、金融」相關的行業來累積資產。', '官祿宮': '你的事業才能偏向執行、管理、或需要行動力的「武職」類型。相較之下，純粹的文書或研究工作可能較不適合你發揮。', '奴僕宮': '你在對待朋友或下屬時總是盡心盡力，但可能回報不成正比。這提醒你在付出時要設立界線，避免因為「不虧待他人」而讓自己受累。', '疾厄宮': '需留意肝臟的保養，避免熬夜，並注意視力保健。若「飛符」同宮，則要額外關心腸道的健康狀況。', '福德宮': '你的內心世界傾向於孤高自賞，喜歡清靜，不願捲入無謂的是非。建議你順應本性，追求精神層面的成長，獨立發展更能讓你找到內心的平靜。', '相貌宮': '你的相貌輪廓分明，可能臉型偏方，整體給人一種骨骼清奇、氣質乾淨的感覺。', '父母宮': '你的家庭背景可能比較特殊，例如有過繼、領養或非典型的家庭連結。與母親的緣分是你需要特別用心維護的課題。' },
    '地乙':   { '命宮': '你有很強的責任感和堅毅的性格，能專注於一個領域深耕。建議你離開原生環境，你的毅力將幫助你克服困難，在新的地方建立起屬於自己的一片天。', '兄弟宮': '你的手足關係可能比較疏遠，或者有非典型的手足連結（例如過繼、領養等）。', '夫妻宮': '在感情選擇上，與年齡稍長或心智成熟的對象交往，關係會更穩定。否則易有病刑傷，二三任妻則無剋。', '子孫宮': '子女的緣分可能會來得比較晚。傳統認為前幾個孩子緣分較淺。', '財帛宮': '你的財富與不動產或土地資源相關。房地產投資的過程可能起伏不定，呈現先散後聚的模式，但最終能從中獲利。', '田宅宮': '你的家庭根基穩固，有機會繼承歷史悠久的祖產，並將其代代相傳下去。', '官祿宮': '你在事業上是個多面手，兼具策劃思考（文）與執行行動（武）的能力，能夠應對多種不同的工作挑戰。', '奴僕宮': '你在管理人際關係或團隊時，會比較辛勞。與下屬或朋友的溝通可能不夠順暢，容易產生摩擦，需要你投入更多心力去磨合。', '疾厄宮': '你的健康養生重點在於「脾胃」。建議你建立規律的飲食習慣，避免生冷或刺激性食物，以維持良好的消化吸收功能。', '福德宮': '你的福氣與家庭根基緊密相連，有很高的機會能夠繼承並守住祖業，在穩定的基礎上安享生活。', '相貌宮': '你的氣質純樸敦厚，膚色可能偏健康的小麥色。若宮位不佳，需注意臉上或外貌可能會有疤痕或損傷。', '父母宮': '你的父母品德賢良，善於教育子女。你與母親的關係可能特別深厚，或是有非典型的家庭背景。' },
    '四神':   { '命宮': '你擁有深刻的洞察力和獨立精神。由於此星帶有水的屬性，建議你可考慮離開家鄉，並從事與「水」相關的行業，例如航運、餐飲、貿易、水產等，將更容易獲得成功。', '兄弟宮': '你與兄弟姊妹的關係可能潛藏著不睦或疏離的風險。', '夫妻宮': '你的感情觀可能帶有精神潔癖。這也可能讓你享受獨處，不強求進入婚姻，更重視心靈的契合。', '子孫宮': '對於第一個孩子需要特別關照。若宮位在申或子，則一子可得平安。', '財帛宮': '你的財運有聚散不常的流動特質。若宮位強旺，則能聚集可觀的財富；若宮位不佳，則需特別注意財務的穩定性。', '田宅宮': '你可能需要離開家鄉置產，且選擇的房產可能靠近水邊（河流、湖泊、海邊）。這是一個能享受美食與安逸生活的訊號。', '官祿宮': '你的事業發展是穩定而長久的類型。建議你選擇一個可以長期深耕的領域，你的專業和資歷將隨著時間累積，帶來持續不斷的成就。', '奴僕宮': '在與朋友或同事的交往中，容易捲入口舌是非。建議你說話謹慎，避免在背後議論他人，以維持和諧的人際關係。', '疾厄宮': '你的體質可能偏虛寒，特別是下半身循環。建議多做能促進血液循環的運動，並注意保暖。同時，也要留意脾胃的保養。', '福德宮': '你的內心可能時常感到孤獨，需要親力親為處理許多事。這是一個提醒你要學習與自己相處，並將這份獨立轉化為內在力量的課題。', '相貌宮': '你的外貌或氣質清秀不凡，帶有灑脫、風流的魅力。', '父母宮': '你可能需要較早地學習獨立，或是有較為複雜的家庭關係（例如父母離異、同父異母等）。' },
    '飛符':   { '命宮': '你的反應快速，學習能力強，對新事物充滿好奇。你可能對命理、玄學、科技或需要精細操作的領域有特殊天分。建議你向外發展，你的聰明才智將是你的最佳利器。', '兄弟宮': '你與手足的緣分可能帶有分離或兩地相隔的特質，例如有同父異母/同母異父的兄弟姊妹，或者因為工作、學業而長期分居兩地。', '夫妻宮': '你的第一段婚姻可能會經歷較大的考驗或波折。二三任妻則無剋。', '子孫宮': '這是一個子女緣分充滿考驗的訊號，提醒你要格外珍惜與孩子的緣分。若只得一個女兒，則女兒的發展會很好。', '財帛宮': '你的財運帶有突發的性質，可能會有意外之財，但也要注意意外的開銷。若同時見到「始擊」，則要加強財務風險管理，慎防破財或竊盜。', '田宅宮': '你的家業或居住地可能有較多變動的跡象。在居住安全上，要特別小心火災風險，做好防火措施。', '官祿宮': '你的事業運帶有爆發性，可能會有快速竄紅或突然成功的機會。但也需要注意，若基礎不穩（居陷），可能會因名聲帶來麻煩。相對來說，需要行動力和決斷力的「武職」會比文職更適合你。', '奴僕宮': '你的社交圈中潛藏著財務風險。這顆星提醒你要避免與朋友有金錢往來，或為人作保，以防因此破財或遭受連累。', '疾厄宮': '需特別注意眼睛和呼吸系統的健康，同時也要留心四肢的意外傷害。日常活動和運動時，應加強安全防護。', '福德宮': '你的人生是挑戰與機遇並存的。雖然可能出身平凡，需要勞心勞力去奮鬥，但過程中也隱藏著意外的福氣，是典型的「災福並行」模式。', '相貌宮': '你的外在舉止可能顯得性情急躁。若宮位不佳，需留意四肢容易有意外的刮傷或疤痕。', '父母宮': '你可能在年少時就離開家庭獨立生活，或是比較難獲得父母在事業或財務上的直接幫助。' },
...
function renderFortuneChart(ageLabels, scoreData) {
    ...
    LIFE_PALACE_NAMES.forEach(shortName => {
        ...
        const palaceId = VALID_PALACES_CLOCKWISE[palaceIndex];
        const palaceBranch = PALACE_ID_TO_BRANCH[palaceId]; // 補上 palaceBranch 的宣告
        ...
        if (coreStars.length === 0) {
            ...
            if (oppositePalaceId && chartModel[oppositePalaceId]) {
                const oppositePalaceData = chartModel[oppositePalaceId];
                let borrowedStars = [...Object.values(oppositePalaceData.stars)];
            ...
            if (trinePartners) {
                ...
                trinePartners.forEach(partnerBranch => {
                    ...
                    if (partnerPalaceId && chartModel[partnerPalaceId]) {
                        let partnerCoreStars = [...Object.values(chartModel[partnerPalaceId].stars)];
                        ...
                        if (partnerGuestPalaceId && chartModel[partnerGuestPalaceId]) {
                            partnerCoreStars.push(...Object.values(chartModel[partnerGuestPalaceId].stars));
                        }
                        trineStars.push(...partnerCoreStars);
                    }
                });
        ...
        if (coreStars.length > 0) {
            ...
            const title = `<strong>${titleParts.join('/')}${borrowedFrom}:</strong>`;
